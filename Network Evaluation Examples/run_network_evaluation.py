...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Analyze network performance on ability to aggregate sets of nodes in network space.')
    ...
    parser.add_argument('-bg', '--background', type=str, default='network', choices=['genesets', 'network'],
                        required=False,
