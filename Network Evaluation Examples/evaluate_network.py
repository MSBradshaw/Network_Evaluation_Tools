...
if os.path.exists('null_AUPRCs.pickle'):
    ...
    pickle.dump(null_AUPRCs,open('null_AUPRCs.pickle','wb'))
...
if os.path.exists('network_performance.pickle'):
    ...
    pickle.dump(network_performance,open('network_performance.pickle','wb'))

#%%

# Calculate network performance gain over median null AUPRC
if os.path.exists('network_perf_gain.pickle'):
    network_performance = pickle.load(open('network_perf_gain.pickle','rb'))
else:
    ...
    pickle.dump(network_perf_gain,open('network_perf_gain.pickle','wb'))
...
if os.path.exists('all_network_performance.pickle'):
    network_performance = pickle.load(open('all_network_performance.pickle','rb'))
    all_network_performance_filt = pickle.load(open('all_network_performance_filt.pickle','rb'))
    network_performance_rank_table = pickle.load(open('network_performance_rank_table.pickle','rb'))
    network_performance_rankings = pickle.load(open('network_perf_gain.pickle','rb'))
else:
    ...
    pickle.dump(all_network_performance,open('all_network_performance.pickle','wb'))
    pickle.dump(all_network_performance_filt,open('all_network_performance_filt.pickle','wb'))
    pickle.dump(network_performance_rank_table,open('network_performance_rank_table.pickle','wb'))
    pickle.dump(network_performance_rankings,open('network_performance_rankings.pickle','wb'))
